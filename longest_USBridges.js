...
// set to the whole world for the new list of international bridges 
...
// The original data... (I changed Location to location, Span to span and cityState to city so it syncs with the other bridge array)
// bridges =  [
//     {"name": "Verrazano-Narrows Bridge", "city: "New York, NY", "span": "1298.4", "location": [40.6066, -74.0447]},
//     {"name": "Golden Gate Bridge", "city": "San Fransico, CA", "span": "1280.2", "location": [37.8199, -122.4783]},
//     {"name": "Mackinac Bridge", "city": "Mackinaw and St. Ignace, MI", "Span": "1158.0", "location": [45.8174, -84.7278]},
//     {"name": "George Washington Bridge", "city": "New York, NY New Jersey, NJ", "span": "1067.0", "location": [40.8517, -73.9527]},
//     {"name": "Tacoma Narrows Bridge", "city": "Tacoma and Kipsap, WA", "span": "853,44", "location": [47.2690, -122.5517]}   
// ]


// big list of almost 1000 bridges 
let bridges =[
    {
...
bridges.forEach(function(bridgeNames){ // sets arrary bridged to loop through longestUSBridges. 
    ...
    // This first marker is not needed - you actually create another marker later in this loop,
    // L.marker(bridgeNames.location, {icon: myIcon}).addTo(map);//creates ICON for marker, displayed on the map.
    //L.marker().addTo(map)
    // This makes another marker - you don't need this one either 
    //L.marker(bridgeMarker.Location) //Marker icon of coordiantes displays on the map 
    
    // same logic - updating property names to match the names used in the bigger bridges array
    let markerText = `<b>${bridgeNames.name}<br> span(Meters) ${bridgeNames.span}<br>${bridgeNames.city} <b>`
    
    // this is the marker with the popup - so use this marker
...
// Now there's a different list of bridges, the chart doesn't work any more
// Can you create an array of spans, and an array of bridge names, from the bridges array? 

let bridgeNames = []  // write code to fill in the data
let bridgeSpans = []  // write code to fill in the data
